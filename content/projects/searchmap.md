...
* **Tech:** Google Maps API, JavaScript, cloud database, REST endpoints.
* **Result:** Reduced manual prospecting time by ~120 hours compared to spreadsheet-based search workflows.
